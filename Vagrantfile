...
Vagrant.configure("2") do |config|
  ...
  # machine will have an IP address of 192.168.51.4 and a virtual network adapter will be
  # created on your host machine with the IP of 192.168.51.1 as a gateway.
  #
