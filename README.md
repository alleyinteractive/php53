...
1. Install the [vagrant-hostsupdater](https://github.com/cogitatio/vagrant-hostsupdater) plugin with `vagrant plugin install vagrant-hostsupdater`
    ...
    * If you choose not to install this plugin, a manual entry should be added to your local `hosts` file that looks like this: `192.168.51.4  local.php53 local.wordpress.php53 local.wordpress-trunk.php53 src.wordpress-develop.php53 build.wordpress-develop.php53`
...
1. Visit any of the following default sites in your browser:
    * [http://local.wordpress.php53/](http://local.wordpress.php53/) for WordPress stable
    * [http://local.wordpress-trunk.php53/](http://local.wordpress-trunk.php53/) for WordPress trunk
    * [http://src.wordpress-develop.php53/](http://src.wordpress-develop.php53/) for trunk WordPress development files
    * [http://build.wordpress-develop.php53/](http://build.wordpress-develop.php53/) for the version of those development files built with Grunt
    * [http://local.php53/](http://local.php53/) for a default dashboard containing several useful tools
...
The network configuration picks an IP of 192.168.51.4. It could cause conflicts on your existing network if you *are* on a 192.168.50.x subnet already. You can configure any IP address in the `Vagrantfile` and it will be used on the next `vagrant up`
